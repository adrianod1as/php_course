				...
				$('#meu_form').validate({
					...
					messages:{
						...
						login:{ 
							...
							minlength: "Pelo menos 3 caracteres.",
							maxlength: "Na maximo 8 caracteres."
						},
						senha: {
...
<hr  color=black size=4 >
	<form id="meu_form" action="create.php" method="post" >
		
		<input type="text" name="nome" id="nome" placeholder="Nome" onKeyup="Obrigue('nome',1)" /><br />
		
		<input type="text" name="login" id="login" placeholder="Login" onKeyup="Obrigue('login',2)" " /><br />
